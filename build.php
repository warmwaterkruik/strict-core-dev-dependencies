...
$metapackage_repository->run('config', ['user.name', 'Alex Pott (via CircleCI)']);
$metapackage_repository->run('config', ['user.email', 'alex.a.pott+strict-core-dev-dependencies@gmail.com']);
